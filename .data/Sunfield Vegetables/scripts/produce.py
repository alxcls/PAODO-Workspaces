"""
produce.py — Harvest a single crop.

Usage:
    python scripts/produce.py basil        # harvests 500 leaves
    python scripts/produce.py bell_pepper  # harvests 2,000 grams
"""
...
def main():
    ...
    print(f"Harvested {amount} {unit} of {ingredient} | new stock: {inventory[ingredient]['quantity']} {unit}")
