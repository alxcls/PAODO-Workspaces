...
- **Agent-to-agent calls** (Opt-in optional functionality): connect workspaces in a directed graph; workspace agents can discover other workspace agents and delegate tasks to each other


## Quick start

**Requirements:** Node.js 20+, Docker (running), an OpenAI API key or an Anthropic API key
...
Browser / API client
  ...
  ┌──────────────────────────────────┐
  │  All agent tools via docker exec │
...
I'm not a professional developer, this is a personal project I built to learn and experiment and have a power tool on shelf to develop small agent services. If you have questions, spot a security issue, want to suggest an improvement, or just feel like sharing feedback, feel free to reach out. Any advice around security, architecture, development practices and vision is genuinely welcome.
