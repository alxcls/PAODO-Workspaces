...
export default function GraphEditor() {
  ...
  // Everything the canvas can delete: drive nodes and any edge. Every node is deletable:false and
  // deleteKeyCode is null, so React Flow never removes anything itself — deleteSelection below is
  // the only path, and it picks up drives only. Agents are deleted from the home page, not here.
