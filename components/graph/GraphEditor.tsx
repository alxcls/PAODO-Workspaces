  ...
  return (
    ...
    >
      ...
      <div className={`flex gap-3 ${hasDescription ? "items-start" : "items-center"}`}>
        <div className={`flex h-[34px] w-[34px] flex-shrink-0 items-center justify-center ${hasDescription ? "mt-[1px]" : ""}`}>
          {icon}
        </div>
...
const DriveIcon = () => (
  <svg viewBox="0 0 24 24" width="34" height="34" fill="none" aria-hidden="true" className="text-primary">
    <path
