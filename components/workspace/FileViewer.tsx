...
const FileViewer = forwardRef<FileViewerHandle, Props>(function FileViewer(
  ...
  // Markdown files can toggle a rendered preview; everything else is source-only. HTML files are no
  // longer previewed here — running apps are viewed via the workspace "Live Server" button, which
  // opens the container's server (port 8080) in a new tab.
