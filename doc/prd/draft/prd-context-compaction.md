...
|----------|-------|--------|
| Exact default token/turn thresholds and N (recent turns to protect) | PM/Engineer | Needs decision |
| How long to persist original turns for undo (TTL) and encryption requirements | Security/Engineer | Needs decision |
| Summarization prompt design (how prescriptive vs. generic) and evaluation criteria | Engineer/Research | Needs decision |
