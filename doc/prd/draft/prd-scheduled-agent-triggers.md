...
|----------|-------|--------|
| Should `maxIterations` be configurable per job or always use the workspace default? | alxcls | Open |
| Are jobs deleted automatically when their workspace is deleted? | alxcls | Open |
