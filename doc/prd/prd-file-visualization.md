...
- **Markdown**: Rendered via `marked` + DOMPurify (already implemented). Output must apply basic typographic styles (headings, bold, lists, code blocks) so it looks like a document, not HTML dump.
