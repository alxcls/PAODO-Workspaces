...
**Access**
- App reachable only by authenticated Tailscale devices; `tailscale serve` proxies to `127.0.0.1:3000` — nothing else reaches port 3000
...
**Supply chain**
- Dependabot weekly PRs + CI gate (`npm audit --audit-level=high`) block high/critical CVE merges
