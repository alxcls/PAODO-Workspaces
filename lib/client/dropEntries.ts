...
export interface DroppedFiles {
  files: PathedFile[];
  /** True when any dropped item was a folder — callers route these through the folder-upload path (ignore-pattern exclusion applied silently) rather than a plain flat-file upload. */
