...
//
// Sibling: ./assertContained.ts assertInsideWorkspace covers the other ergonomics — an absolute path
// from an HTTP file route, throwing PathContainmentError so the route can map it to a 4xx.
