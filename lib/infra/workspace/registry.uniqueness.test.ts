...
let isInternetAccessEnabled: (typeof import("../proxy/internetAccessPolicy"))["isInternetAccessEnabled"];
...
beforeEach(async () => {
  ...
  ({ isInternetAccessEnabled } = await import("../proxy/internetAccessPolicy"));
});
