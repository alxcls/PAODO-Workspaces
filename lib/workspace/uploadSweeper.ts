// Sweeps orphaned upload temp files out of WORKSPACES_ROOT. fileUpload.ts cleans up its own temp
...
// Matches the temp file name fileUpload.ts creates: `${resolved}.${randomBytes(6).toString("hex")}.part`.
